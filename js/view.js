      ...
      case "MOVED":
        (function (event) {
          ...
          if (event.pageX > 0 && event.pageX > 0) {
            target.style.left =
              ((event.pageX - target.offsetWidth / 2) / window.innerWidth) *
                100 +
              "%";
            target.style.top =
              ((event.pageY - target.offsetHeight / 5) / window.innerHeight) *
                100 +
              "%";
          }
        })(el);
